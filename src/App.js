...
export class Page extends Component {
		render() {
			return (
				<div>
					<NavBar/>
					<a id="hero"><HeroBanner image="images/couple.jpg" title="Save the date." date="Oct 17th 2021" event="The wedding of Justin Thomas Oakes and Madeline Elizabeth Hudson"/></a>
					<a id="map"><Map/></a>
